...
### Deploy to Heroku
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/TitterBuck/Manual-Filter-Bot)

### Deploy in your vps
```sh
git clone https://github.com/TitterBuck/Manual-Filter-Bot
